...
namespace InvestmentReport.Domain.Investments
{
    ...
    public sealed class Investment : IInvestment
    {
        ...
        public ETypeInvestment Type { get; private set; }
        ...
        internal Investment(ETypeInvestment typeInvestment, InvestmentData data)
        {
            this.taxes = new List<ITax>();
            this.guaranteeList = new List<IGuarantee>();

            this.Type = typeInvestment;
        ...
        public IInvestment CalculateRedemptionValue()
        {
        ...
        public IInvestment CalculateTaxes()
        {
        ...
        public IInvestment AddTaxes(ITax tax)
        {
        ...
        public IInvestment AddGuarantee(IGuarantee guarantee)
        {
